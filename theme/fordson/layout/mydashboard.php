...
$primarynav = $PAGE->navigation->get('page');
$secondarynav = $PAGE->navigation->get('page');

if ($primarynav !== false && $secondarynav !== false) {
    $templatecontext['primarynavigation'] = $primarynav;
    $templatecontext['secondarynavigation'] = $secondarynav;

    // Assuming you want to get the collection label from the primary navigation:
    $collectionLabel = $primarynav->get('collection_label');
    if ($collectionLabel !== false) {
